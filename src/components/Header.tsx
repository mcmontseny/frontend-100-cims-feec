const Header = () => {
    return (
        <header className="bg-black text-white border-b shadow-sm sticky top-0 z-20 px-4 py-2 md:px-6 md:py-4 flex-shrink-0">
            <div className="flex items-center justify-between">
                <a className="flex items-center gap-2 font-bold text-lg hover:text-neutral-500" href="/">
                    ...
                    <span className="text-lg">Repte 100 Cims</span>
                </a>
