...
function MountainDetail({ onClose, mountain, ascents, activities }: MountainDetailProps) {
    ...
    const customTheme: CustomFlowbiteTheme["drawer"] = {
        root: {
            "base": "fixed z-40 bg-white transition-transform dark:bg-gray-800 rounded-t-2xl max-h-[80%]",
                    ...
                    <div className="flex flex-col relative">
                        ...
                        {mountain && (
                            <>
                                ...
                                <div className="flex flex-col gap-[12px] p-4 overflow-y-auto" style={{ height: '320px'}}>
                                    ...
                                    <div className="flex flex-col">
                                        <h3 className="whitespace tracking-tight text-2xl font-bold">{mountain.name}</h3>
                                        <span className="text-neutral-500 text-sm">{mountain.height} m</span>
                                    </div>

                                    <h3 className="whitespace-nowrap tracking-tight text-xl font-bold">Fitxa técnica</h3>
                                    ...
                                    <div className="flex flex-col gap-[8px]">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm">{mountain.region}</span>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-2" data-id="18">
                                            ...
                                            <span className="text-sm">{mountain.latitude}, {mountain.longitude}</span>
                                        </div>

                                        <div className="flex items-center gap-2">
                                            <a
                                                className="text-sm hover:underline text-[#737373]"
                                                href={mountain.url}
                                                target="_blank"
                                                rel="noreferrer"
                                            >
                                    ...
                                    <h3 className="whitespace-nowrap tracking-tight text-xl font-bold">Detall ascensió</h3>
                                        ...
                                        {(mountainIsCompleted && mountainActivity) && (
                                            <div className="rounded-lg border shadow-sm h-auto p-4 flex flex-col gap-3">
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <div className="flex flex-col">
                                                        <h3 className="font-semibold">{mountainActivity.name}</h3>
                                                        <p className="text-neutral-500 text-sm">{formatDateLongWithTime(mountainActivity.start_date_local)}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <div className="font-medium">Distància:</div>
                                                        </div>
                                                        <span className="font-semibold">{formatDistance(mountainActivity.distance)}</span>
                                                    </div>
                                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <div className="font-medium">Temps en moviment:</div>
                                                        </div>
                                                        <span className="font-semibold">{formatTime(mountainActivity.moving_time)}</span>
                                                    </div>
                                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                        <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="font-semibold">{convertSpeedToKmh(mountainActivity.average_speed)} km/h</span>
                                                    </div>
                                                    <div className="flex items-center gap-2 text-sm text-muted-foregorund">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <div className="font-medium ">Desnivell positiu:</div>
                                                        </div>
                                                        <span className="font-semibold">{Math.round(mountainActivity.total_elevation_gain)} m</span>
                                                    </div>
                                                </div>
                                                <div className="flex items-center">
                                                    <a className="text-sm hover:underline text-[#737373]" href={`https://strava.com/activities/${mountainActivity.id}`}
                                                    target="_blank"
                                                       rel="noreferrer"
                                                    >
                                                        Veure més
